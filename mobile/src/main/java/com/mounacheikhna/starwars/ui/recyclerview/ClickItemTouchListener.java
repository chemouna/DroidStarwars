package com.mounacheikhna.starwars.ui.recyclerview;
...
/**
 * An {@link OnItemTouchListener} to handle touch for {@link RecyclerView}.
 */
abstract class ClickItemTouchListener implements OnItemTouchListener {
  ...
  ClickItemTouchListener(RecyclerView hostView) {
    mGestureDetector =
        new ItemClickGestureDetector(hostView.getContext(), new ItemClickGestureListener(hostView));
  }
