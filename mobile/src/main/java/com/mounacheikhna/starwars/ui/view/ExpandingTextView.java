...
package com.mounacheikhna.starwars.ui.view;
...
/**
 * A {@link TextView} that expands when tapped.
 */
public class ExpandingTextView extends TextView implements View.OnClickListener {
  ...
  public ExpandingTextView(Context context, AttributeSet attrs, int defStyle) {
    ...
    TypedArray a =
        context.obtainStyledAttributes(attrs, R.styleable.ExpandingTextView, 0, defStyle);
    mCollapsedMaxLines = a.getInt(R.styleable.ExpandingTextView_collapsed_maxLines, 8);
    mExpanded = a.getBoolean(R.styleable.ExpandingTextView_tv_expanded, false);
    a.recycle();
